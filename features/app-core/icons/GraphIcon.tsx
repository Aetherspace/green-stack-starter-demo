...
const GraphIcon = (props) => (
  <Svg width={24} height={24} viewBox="0 0 134 134" fill="#e10098" {...props}>
    <Path d="M-.43 12.534h22.901v1.187H-.43z" transform="rotate(-59.999 45.918 54.695) scale(4.16667)" />
    <Path d="M4.545 21.162h22.902v1.187H4.545z" transform="scale(4.16667)" />
    <Path d="M10.43 18.008h1.187v13.227H10.43z" transform="rotate(-59.999 45.93 102.593) scale(4.16667)" />
    <Path d="M20.381.771h1.187v13.227h-1.187z" transform="rotate(-59.999 87.393 30.767) scale(4.16667)" />
    <Path d="M4.412 6.787h13.227v1.187H4.412z" transform="rotate(-30.001 45.942 30.752) scale(4.16667)" />
    <Path d="M20.389 1.677h1.187v22.901h-1.187z" transform="rotate(-30.001 87.423 54.7) scale(4.16667)" />
    <Path d="M5.454 9.386h1.187v13.228H5.454zM25.36 9.386h1.187v13.228H25.36z" transform="scale(4.16667)" />
    <Path d="M15.222 24.097h11.504v1.037H15.222z" transform="rotate(-30.001 87.389 102.564) scale(4.16667)" />
    <Path
