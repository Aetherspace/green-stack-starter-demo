...
const propSchema = ats.schema('ExpoIconProps', {
  ...
  fill: ats.color().optional().default('#333333', '#000000', 'Icon fill color'),
})

/* --- <ExpoIcon/> ----------------------------------------------------------------------------- */

const ExpoIcon = (props) => (
  <Svg width={24} height={24} viewBox="0 0 24 26" fill="#333333" xmlns="http://www.w3.org/2000/svg" {...props}>
