...
const ImagesScreen = () => (
  <View className="flex flex-1 justify-center items-center bg-slate-800">
    ...
    <Image
      ...
      height={60}
    />
    <Text className="mt-2 mb-4 text-primary-200 text-center text-base">src=static-require | width: 60 | height: 60</Text>
    {/* - Example 2 - */}
    <Image
      ...
      height={60}
    />
    <Text className="mt-2 mb-4 text-primary-200 text-center text-base">src=external-url | width: 60 | height: 60</Text>
    {/* - Example 3 - */}
    ...
    <Text className="mt-2 mb-4 text-primary-200 text-center text-base">wrapper=50x80, relative | fill=true</Text>
    {/* - Example 4 - */}
    ...
    <Text className="mt-2 mb-4 text-primary-200 text-center text-base">wrapper=80x60, relative | fill | contentFit=contain</Text>
  </View>
)
