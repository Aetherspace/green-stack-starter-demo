...
var getEnvVar = function (key) {
    ...
    var checkEnv = function (k) { var _a, _b; return process.env[k] || ((_a = expo_constants_1.default.manifest.extra) === null || _a === void 0 ? void 0 : _a[k]) || ((_b = getGlobal(__PUBLIC_ENV)) === null || _b === void 0 ? void 0 : _b[k]); };
