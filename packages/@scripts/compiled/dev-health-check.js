...
var timesTried = 0;
/* --- checkHealth ----------------------------------------------------------------------------- */
var checkHealth = function () { return __awaiter(void 0, void 0, void 0, function () {
    var res, err_1, retryMs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.post(ENDPOINT, { test: 'Hello World' })];
            case 2:
                res = _a.sent();
